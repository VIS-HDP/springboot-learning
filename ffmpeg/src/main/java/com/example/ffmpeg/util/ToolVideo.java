...
//  private static final Logger LOG = LoggerFactory.getLogger(ToolVideo.class);
    ...
    // 获取要取得的帧数
    private static final int GET_FRAMES_LENGTH = 3;

    public static void main(String[] args) {
        Map<String, Object> screenshot1 = getScreenshot("D:\\111\\117.mp4");
        System.out.println(screenshot1.toString());
        Map<String, Object> screenshot = getScreenshot("D:\\111\\119.mp4");
